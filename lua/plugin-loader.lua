...
vim.cmd([[
  augroup packer_user_config
    autocmd!
    autocmd BufWritePost plugin-config.lua source <afile> | PackerCompile | PackerSync
    autocmd BufWritePost plugin-loader.lua source <afile> | PackerCompile | PackerSync
  augroup end
]])
